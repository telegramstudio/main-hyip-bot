...
class AddressConstructor
  ...
  def initialize
    ...
    @bcc_wallet = client.account('27402c2e-9278-5ec0-8be4-e37b64464358')
    @btc_wallet = client.account('d88b1c58-b048-5924-b226-cb1aef4b6df3')
  end

  def generate_btc
    p @btc_wallet.create_address
  end
  
  def generate_ltc
    p @ltc_wallet.create_address
  end
 
  def generate_eth
    p @eth_wallet.create_address
  end 

  def generate_bcc
    p @bcc_wallet.create_address
  end 
